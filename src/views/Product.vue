...
import HeaderHaneeda from '@/components/HeaderHaneeda.vue';
import FooterHaneeda from '@/components/FooterHaneeda.vue';
import RelatedHaneeda from '@/components/RelatedHaneeda.vue';
